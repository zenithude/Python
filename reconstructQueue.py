...
If the position of the shortest person is i, how many people would be in
front of the shortest person?
...
class Solution:
    def reconstructQueue(self, people):
        """
        Function that returns a list sorted by the size of the people.
